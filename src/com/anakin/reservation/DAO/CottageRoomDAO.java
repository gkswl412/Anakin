...
public class CottageRoomDAO {
	...
	public static final String SELECT_COTTAGE_ROOM_BY_NAMES_WITH_JOIN = "select * from cottage_room inner join cottage using (cottage_id)";
	...
	public CottageRoomVO selectCottageRoomByNamesWithJoin(String room_name, String cottage_name) {
