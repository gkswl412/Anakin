...
public class Cottage_RoomVO {
	...
	public Cottage_RoomVO(long room_id, String room_name, int room_count, int room_occupancy, int room_standard_price, 
			int room_holiday_price, int room_peak_season_price, int room_tv_count, int room_bathroom_count, String room_balcony_option, String room_status, String room_description ) {
		super();
	...
	public Cottage_RoomVO(int cottage_id, long room_id, String room_name, int room_occupancy, int room_standard_price,
	...
	public void setRoom_holiday_price(int room_holyday_price) {
		this.room_holiday_price = room_holyday_price;
	}
