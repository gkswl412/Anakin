...
public class ReviewVO1 {
 ...
 public ReviewVO1(int review_id, String review_comment) {
	 super();
		this.review_id = review_id; 
		this.review_comment = review_comment;
 };

public ReviewVO1(int review_id, String review_title, String review_pw, String review_writer, Date review_date,
