...
<section>
	<div style="margin:150px 0 0 0; text-height:18px">
		...
		<div style="sidth:65%; height:50px; margin:0 auto">
		</div>
		<div style="width:65%; margin:0 auto">
  			<nav>
  				<div style="margin:0; text-align:left; border-bottom:1px solid #0000006F">
  					...
  					<div style="float:right; width:100%; height:100%"></div>
  				</div>
  			</nav>
  			<div id="here">
  				<table border=1>
  					<c:forEach var="item" items="${roomList}">
  						<tr>
  							<th rowspan=3><img src=""></th><td>${item.room_name}</td>
  						</tr>
  						<tr>
  							<td>${item.room_standard_price}</td>
  						</tr>
  						<tr>
